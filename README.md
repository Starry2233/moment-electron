...
1. 本项目仅供学习研究 V3 API 协议与技术原理使用。
2. 使用 Full 模式直连官方服务器可能导致**设备被封禁、账号被限制功能**。
3. 开发者不对任何因使用本项目造成的**封号、设备锁定、数据丢失**等后果负责。
4. 请自行承担所有风险，建议使用备用设备/账号进行测试。
5. 禁止用于任何商业用途、非法目的或对小天才服务器造成压力的行为。
6. 如不同意以上条款，请立即删除本项目。
